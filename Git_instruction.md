...
## 7. Логотип сторонней программы контррля версий git.
...
## . Сторонние программы для контроля версий git.

Существует множетсво программ сторонних производителей и одна из них GitKraken.
